...
{
  theta1 = DEG_TO_RAD * angleposition.Theta1;
  theta2 = DEG_TO_RAD * angleposition.Theta2;
  theta3 = DEG_TO_RAD * angleposition.Theta3;
 
//  sprintf(TxData ,"/%f,%f,%f;" ,theta1 ,theta2 ,theta3); 
