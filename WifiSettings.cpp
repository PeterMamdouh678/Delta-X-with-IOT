...
{
	char ssidWifi[32] = "SmartFactory"; // Wifi ID
	char pswdWifi[32] = "SmartFactory22#"; // Wifi Password
...
{
	char ipWifi[32] = "192.168.100.60"; // Wifi IP using ipconfig from CMD, get the gateway.
